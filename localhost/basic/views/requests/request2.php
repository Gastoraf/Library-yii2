...
<div class="alert" style="background: white">
  Получить список и общее число всех читателей-задолжников,
  задолжников со сроком более 10 дней на данном абоненте либо по всей библиотеке,
...
<div class="container">
  <div class="row">
    <div class="col-12 col-md-6">
      ...
      <?= $form->field($filterModel, 'is_ten')->checkbox(['checked' => true])->label('Задолжники со сроком более 10 дней'); ?>
      ...
      <div class="form-group">
        ...
        <?= Html::a('Показать все', ['requests/request2'], ['class' => 'btn btn-success']) ?>
      </div>
      <?php ActiveForm::end(); ?>
    </div>
  </div>
